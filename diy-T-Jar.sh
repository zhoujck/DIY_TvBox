...
sed -i 's#"app_source"><#"app_source">https://ghproxy.net/https://raw.githubusercontent.com/zhoujck/config/master/box<#g' $CURRENT_DIR/$DIR/app/src/main/res/values-zh/strings.xml
